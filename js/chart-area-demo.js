...
for (let i = 0; i < datetimes.length; i++) {
  data.push({x:datetimes[i], y:ice_thick[i]})
}
...
var theChart1 = new Chart(ctx1, config);
var theChart2 = new Chart(ctx2, config);
var theChart3 = new Chart(ctx3, config);
var theChart4 = new Chart(ctx4, config);
var theChart5 = new Chart(ctx5, config);
var theChart6 = new Chart(ctx6, config);
